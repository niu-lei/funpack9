                                     ...
                                     uint8_t Value[])
{
  ...
  /* var_len_data input */
  {
    BLUENRG_memcpy((void *) &cp0->Value, (const void *) Value, Length);
    index_input += Length;
  }
  BLUENRG_memset(&rq, 0, sizeof(rq));
  rq.ogf = 0x3f;
                                    ...
                                    uint8_t Data[])
{
  ...
  *Data_Length = btoh(resp.Data_Length, 1);
  BLUENRG_memcpy((void *) Data, (const void *) resp.Data, *Data_Length);
  return BLE_STATUS_SUCCESS;
}
                                         ...
                                         uint8_t Data[])
{
  ...
  /* var_len_data input */
  {
    BLUENRG_memcpy((void *) &cp0->Data, (const void *) Data, Data_Length);
                                         ...
                                         uint8_t Data[])
{
  ...
  BLUENRG_memcpy((void *) Data, (const void *) resp.Data, *Data);
  return BLE_STATUS_SUCCESS;
}
