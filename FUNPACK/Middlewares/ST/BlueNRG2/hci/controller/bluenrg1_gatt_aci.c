                                  ...
                                  uint16_t *Char_Desc_Handle)
{
  ...
  /* var_len_data input */
  {
    ...
    index_input += 1;
    BLUENRG_memcpy((void *) &cp1->Char_Desc_Value, (const void *) Char_Desc_Value, Char_Desc_Value_Length);
                                      ...
                                      uint8_t Char_Value[])
{
  ...
  /* var_len_data input */
  {
    BLUENRG_memcpy((void *) &cp0->Char_Value, (const void *) Char_Value, Char_Value_Length);
                                          ...
                                          uint8_t Attribute_Val[])
{
  ...
  /* var_len_data input */
  {
    BLUENRG_memcpy((void *) &cp0->Attribute_Val, (const void *) Attribute_Val, Attribute_Val_Length);
                                             ...
                                             Handle_Entry_t Handle_Entry[])
{
  ...
  /* var_len_data input */
  {
    BLUENRG_memcpy((void *) &cp0->Handle_Entry, (const void *) Handle_Entry, Number_of_Handles);
                                   ...
                                   uint8_t Char_Desc_Value[])
{
  ...
  /* var_len_data input */
  {
    BLUENRG_memcpy((void *) &cp0->Char_Desc_Value, (const void *) Char_Desc_Value, Char_Desc_Value_Length);
    index_input += Char_Desc_Value_Length;
  }
  BLUENRG_memset(&rq, 0, sizeof(rq));
  rq.ogf = 0x3f;
                                      ...
                                      uint8_t Value[])
{
  ...
  *Value_Length = btoh(resp.Value_Length, 2);
  BLUENRG_memcpy((void *) Value, (const void *) resp.Value, *Value_Length);
  return BLE_STATUS_SUCCESS;
}
                                          ...
                                          uint8_t Value[])
{
  ...
  /* var_len_data input */
  {
    BLUENRG_memcpy((void *) &cp0->Value, (const void *) Value, Value_Length);
