                                            ...
                                            uint16_t Slave_Conn_Interval_Max)
{
  ...
  /* var_len_data input */
  {
    BLUENRG_memcpy((void *) &cp0->Local_Name, (const void *) Local_Name, Local_Name_Length);
    index_input += Local_Name_Length;
    {
      cp1->Service_Uuid_length = htob(Service_Uuid_length, 1);
    }
    index_input += 1;
    BLUENRG_memcpy((void *) &cp1->Service_Uuid_List, (const void *) Service_Uuid_List, Service_Uuid_length);
                                   ...
                                   uint8_t AdvData[])
{
  ...
  /* var_len_data input */
  {
    BLUENRG_memcpy((void *) &cp0->AdvData, (const void *) AdvData, AdvDataLen);
                                                        ...
                                                        Whitelist_Entry_t Whitelist_Entry[])
{
  ...
  /* var_len_data input */
  {
    BLUENRG_memcpy((void *) &cp0->Whitelist_Entry, (const void *) Whitelist_Entry, Num_of_Whitelist_Entries);
                                      ...
                                      Whitelist_Entry_t Whitelist_Entry[])
{
  ...
  /* var_len_data input */
  {
    BLUENRG_memcpy((void *) &cp0->Adv_Data, (const void *) Adv_Data, Adv_Data_Length);
    index_input += Adv_Data_Length;
    {
      cp1->Num_of_Whitelist_Entries = htob(Num_of_Whitelist_Entries, 1);
    }
    index_input += 1;
    BLUENRG_memcpy((void *) &cp1->Whitelist_Entry, (const void *) Whitelist_Entry, Num_of_Whitelist_Entries);
    index_input += Num_of_Whitelist_Entries;
  }
  BLUENRG_memset(&rq, 0, sizeof(rq));
  rq.ogf = 0x3f;
                                      ...
                                      Bonded_Device_Entry_t Bonded_Device_Entry[])
{
  ...
  *Num_of_Addresses = btoh(resp.Num_of_Addresses, 1);
  BLUENRG_memcpy((void *) Bonded_Device_Entry, (const void *) resp.Bonded_Device_Entry, *Num_of_Addresses);
  return BLE_STATUS_SUCCESS;
}
                                                 ...
                                                 uint8_t Clear_Resolving_List)
{
  ...
  /* var_len_data input */
  {
    BLUENRG_memcpy((void *) &cp0->Whitelist_Identity_Entry, (const void *) Whitelist_Identity_Entry, Num_of_Resolving_list_Entries);
